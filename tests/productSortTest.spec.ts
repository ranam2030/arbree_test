...
test.describe("Product Sort", () => {
    ...
    test("should sort products by name A to Z",{tag: ["@smoke"],annotation:[{type: "TestCaseURL", description: "www.google.com"}]}, async ({ ProductPage }) => {
    ...
    test("should sort products by name Z to A",{tag: ["@smoke"],annotation:[{type: "TestCaseURL", description: "www.google.com"}]}, async ({ ProductPage }) => {
    ...
    test("should sort products by price low to high",{tag: ["@smoke"],annotation:[{type: "TestCaseURL", description: "www.google.com"}]}, async ({ ProductPage }) => {
    ...
    test("should sort products by price high to low",{tag: ["@smoke"],annotation:[{type: "TestCaseURL", description: "www.google.com"}]}, async ({ ProductPage }) => {
    ...
    test("should display products in Name A to Z order by default",{tag: ["@smoke"],annotation:[{type: "TestCaseURL", description: "www.google.com"}]}, async ({ ProductPage }) => {
    ...
    test("should keep product count unchanged after each sort",{tag: ["@smoke"],annotation:[{type: "TestCaseURL", description: "www.google.com"}]}, async ({ ProductPage }) => {
    ...
    test("should show cheapest product first after price low to high sort",{tag: ["@smoke"],annotation:[{type: "TestCaseURL", description: "www.google.com"}]}, async ({ ProductPage }) => {
        await test.step("Apply sort: Price (low to high)", async () => {
            await ProductPage.sortBy('lohi');
        });
    ...
    test("should show most expensive product first after price high to low sort",{tag: ["@smoke"],annotation:[{type: "TestCaseURL", description: "www.google.com"}]}, async ({ ProductPage }) => {
        await test.step("Apply sort: Price (high to low)", async () => {
            await ProductPage.sortBy('hilo');
        });
    ...
    test("should have exactly 4 options in the sort dropdown",{tag: ["@smoke"],annotation:[{type: "TestCaseURL - ", description: "www.google.com"}]}, async ({ ProductPage }) => {
